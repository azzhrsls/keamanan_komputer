      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h4>Contact GAZEWHY via Whatsapp</h4>
            <p><i>Klik icon Whatsapp</i></p>
            <a href="https://wa.link/78y8b6">
                <img src="{{'PhotoFolio/assets/img/whatsapp.png'}}" alt="">
            </a>
          </div>
        </div>
      </div>
