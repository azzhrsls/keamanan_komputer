      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h3>Paket - Paket di Studio Foto GAZEWHY</h3>

            <a class="cta-btn" href="contact">Tanya lebih lanjut mengenai GAZEWHY</a>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="{{asset ('PhotoFolio/assets/img/profile-img.jpg')}}" class="img-fluid" alt="">
          </div>
